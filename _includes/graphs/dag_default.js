// Observed: blue, not observed: yellow
// Directly randomly assigned: box
// Indirectly randomly assigned: ellipse
...
var network2 = new vis.Network(
	...
	edges: new vis.DataSet([
	    {from: 2, to: 6, arrows: {to: true}},
	    {from: 6, to: 4, arrows: {to: true}},
	    {from: 6, to: 5, arrows: {to: true}},
	    {from: 2, to: 1, arrows: { to : true}},
	    {from: 2, to: 3, arrows: { to : true}},
	    {from: 3, to: 4, arrows: { to : true}},
	    {from: 2, to: 4, arrows: { to : true}},
